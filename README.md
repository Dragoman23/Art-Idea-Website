...
## How it Works
It was made using 2 html files(topic.html, medium.html) for the two webpages. These two pages allow movement between each other using a navigation bar at the top of the page. 
